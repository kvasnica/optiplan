classdef Agent < moantool.utils.OMPBaseClass
    ...
    methods
        ...
        function obj = Agent(varargin)
            ...
            obj.X = moantool.AgentSignal([obj.nx 1], obj.N+1, 'X');
            obj.U = moantool.AgentSignal([obj.nu 1], obj.N, 'U');
            obj.Y = moantool.AgentSignal([obj.ny 1], obj.N, 'Y');

            % add geometry signals (currently only size)
            obj.Size = moantool.AgentSignal([obj.ny 1], obj.N, 'Size');
...
%         end
        ...
        function data = getOptimizerData(obj, prefix)
            ...
            data = getOptimizerData@moantool.utils.OMPBaseClass(obj, prefix);
        ...
        function J = objective(obj)
            ...
            J = objective@moantool.utils.OMPBaseClass(obj);
        ...
        function cons = constraints(obj)
            ...
            cons = constraints@moantool.utils.OMPBaseClass(obj);
