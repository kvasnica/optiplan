classdef LinearAgent < moantool.Agent
    ...
    methods
        ...
        function cons = constraints(obj)
            ...
            cons = constraints@moantool.Agent(obj);
    ...
    methods(Static)
        function mpcoptions = demo2Ddata(Ts)
            ...
            %
            % see "help moantool.LinearAgent.demo2D
        ...
        function [agent, mpcoptions] = demo2D(varargin)
            ...
            %
            %   agent = moantool.AgentFactory.DemoAgent2D('PredictionHorizon', N, 'SamplingTime', Ts)
            %
            ...
            if nargin==0
                help moantool.LinearAgent.demo2D
                if nargout==1
                    agent = [];
                end
                return
            ...
            agent = moantool.LinearAgent('nx', 4, 'nu', 2, 'ny', 2, ...
                'PredictionHorizon', options.PredictionHorizon);
            
            % sample dynamics/constraints
            mpcoptions = moantool.LinearAgent.demo2Ddata(options.SamplingTime);
